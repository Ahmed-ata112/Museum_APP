      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(icon: const Icon(
              Icons.bungalow, size: 30.0), onPressed: () {
            //
          }),
        ],
      ),
        ...
        child:StaggeredGridView.count(
          ...
          children: [
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        [
                          Text('Statistics', style: TextStyle(color: Colors.blueAccent, fontSize: 24)),
                              ...
                              child: Padding
                                ...
                                child: Center(
                                  child: Column(children:<Widget> [
                                    ...
                                    SizedBox(height: 20,),
                                    Icon(Icons.pie_chart, color: Colors.white, size: 30.0),
                                    SizedBox(height: 20,),
            ...
            _buildTile(
                    ...
                    (
                      ...
                      [
                        Column
                          ...
                          children: const <Widget>
                          [
                            Text('Insert New Goods', style: TextStyle(color: Colors.blueAccent, fontSize: 24)),
                ...
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> insert_goods()));
                }
            ),
            ...
            _buildTile(
                    ...
                    (
                      ...
                      [
                        Column
                          ...
                          children: const <Widget>
                          [
                            Text('Update Existing Goods', style: TextStyle(color: Colors.blueAccent, fontSize: 24)),
                            ...
                            child: const Center
                              (
                                child: Padding
                                  (
                                  padding: EdgeInsets.all(16.0),
                                  child: Icon(Icons.autorenew , color: Colors.white, size: 30.0),
                                )
                            )
                        )
                      ]
                ...
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> update_goods()));
                }
            ),
