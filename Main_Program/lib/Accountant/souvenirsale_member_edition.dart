...
class SouvenirSale_member_edition extends StatefulWidget {
  ...
  @override
  SouvenirSale_member_editionState createState() =>
      SouvenirSale_member_editionState(S);
}

class SouvenirSale_member_editionState
    extends State<SouvenirSale_member_edition> {
  List<Souvenir> S;
