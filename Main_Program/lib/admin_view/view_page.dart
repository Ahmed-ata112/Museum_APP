...
class view_home extends StatefulWidget {
  const view_home({Key? key}) : super(key: key);

  @override
  _view_homeState createState() => _view_homeState();
}

class _view_homeState extends State<view_home> {
  @override
