...
class addNewSouvenir extends StatefulWidget {
  @override
  _addNewSouvenirState createState() => _addNewSouvenirState();
}

class _addNewSouvenirState extends State<addNewSouvenir> {
